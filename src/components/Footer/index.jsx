      ...
      <aside className="footer__logo-link-container">
        ...
        <div className="footer__link-container">
          ...
          <div className="social-media__link-container">
            <a href="www.facebook.com" className="social-media__link"><FBIcon /></a>
            <a href="www.youtube.com" className="social-media__link"><YTIcon /></a>
            <a href="www.twitter.com" className="social-media__link"><TwitIcon /></a>
            <a href="www.pinterest.com" className="social-media__link"><PinIcon /></a>
            <a href="www.instagram.com" className="social-media__link"><InstaIcon /></a>
          </div>
        </div>
